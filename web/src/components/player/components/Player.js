  ...
  (function (_Component) {
    ...
    function SanityMuxPlayer() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(SanityMuxPlayer)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
            ...
            if (_hls.default.isSupported()) {
              ...
              this.video.current.addEventListener("error", function () {
                ...
                _this2.setState({
                  error: {
                    type: ""
                      .concat(_this2.video.current.error.constructor.name, " code ")
                      .concat(_this2.video.current.error.code),
                  },
                });
